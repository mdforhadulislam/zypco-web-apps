...
const ZypcoTeamMember = () => {
  const leadership = [
    {
      ...
      social: {
        email: "arafat@zypco.com",
        linkedin: "#",
        phone: "+880 1991111111"
      }
    },
    {
      id: 2,
    ...
    },
    {
      ...
      social: {
        email: "tanvir@zypco.com",
        linkedin: "#",
        phone: "+880 1993333333"
      }
    }
  ];
  ...
  const departments = [
    {
      ...
      count: 8,
      description: "Managing daily logistics operations and ensuring smooth delivery processes"
    },
    {
    ...
    },
    {
      ...
      count: 2,
      description: "Developing and maintaining our digital platforms and tracking systems"
    },
    {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Teamwork",
      description: "We achieve more together and support each other's growth and success"
    },
    {
      icon: <Target className="w-6 h-6 text-[#FEF400]" strokeWidth={1.5} />,
      title: "Excellence",
      description: "We strive for excellence in everything we do, from service to innovation"
    },
    {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Behind every successful delivery is a dedicated team of professionals who are passionate 
              about connecting Bangladesh with the world. Get to know the people who make Zypco possible.
            </p>
          </div>
      ...
      <div className="w-full bg-gray-50">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#241F21] mb-4">Our Marque Associates</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Meet the dedicated associates who represent Zypco on the ground and ensure smooth operations every day.
            </p>
          </div>
          
          <div className="max-w-6xl mx-auto space-y-12">
            {leadership.map((leader, index) => (
              <div key={leader.id} className={`flex flex-col lg:flex-row items-center gap-8 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className="lg:w-2/3 lg:px-8">
                  <div className="bg-white rounded-lg p-8 shadow-lg">
                    <h3 className="text-2xl font-bold text-[#241F21] mb-2">{leader.name}</h3>
                    <p className="text-[#FEF400] font-semibold mb-4">{leader.position}</p>
                    ...
                    <div className="mb-6">
                      <h4 className="font-semibold text-[#241F21] mb-3">Key Achievements:</h4>
                    ...
                    <div className="flex gap-4">
                      <a href={`mailto:${leader.social.email}`} className="flex items-center gap-2 text-[#241F21] hover:text-[#FEF400] transition-colors">
                        <Mail className="w-4 h-4" />
                        <span className="text-sm">Email</span>
                      </a>
                      <a href={leader.social.linkedin} className="flex items-center gap-2 text-[#241F21] hover:text-[#FEF400] transition-colors">
                        <Linkedin className="w-4 h-4" />
                        <span className="text-sm">LinkedIn</span>
                      </a>
                      <a href={`tel:${leader.social.phone}`} className="flex items-center gap-2 text-[#241F21] hover:text-[#FEF400] transition-colors">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Each department plays a crucial role in delivering exceptional courier services
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {departments.map((dept, index) => (
              <div key={index} className="bg-[#2A2529] rounded-lg p-6 text-center hover:bg-[#323035] transition-colors">
                ...
                <div className="text-2xl font-bold text-[#FEF400] mb-3">{dept.count}</div>
      ...
      <div className="w-full bg-[#241F21]">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            connecting Bangladesh with the world. Explore career opportunities with us.
          </p>
          <div className="space-x-4">
            <a href="/career" className="inline-block bg-[#FEF400] text-[#241F21] py-3 px-8 rounded-lg hover:bg-yellow-500 transition-colors font-semibold">
              View Career Opportunities
            </a>
            <a href="/contact" className="inline-block border-2 border-white text-white py-3 px-8 rounded-lg hover:bg-white hover:text-[#241F21] transition-colors font-semibold">
              Contact Us
            </a>
          </div>
        </div>
