          ...
          <div className="w-full h-auto grid grid-cols-1 md:grid-cols-2 gap-4 items-center align-middle justify-center mt-14">
            ...
            <div className="w-full h-auto p-6">
              <p className="font-semibold text-xl">
                Zypco was founded with a clear vision: to make international
              ...
              <p className="font-medium text-base">
                ...
                existed. With this in mind, Zypco began as a home-office model,
              ...
              <p className="font-medium text-base">
                ...
                solutions: offering doorstep pickup, seamless processing, and
                safe delivery to the right courier hub. Whether it’s important
                documents, personal gifts, or commercial shipments, Zypco
                ensures every package is handled with care.
              </p>
              <br />
              <p className="font-semibold text-lg">
                Today, Zypco continues to grow — but our foundation remains the
